...
import { diagnosePaymentDegradation } from "@/lib/pipelines/payment-degradation/agent";
import { qualifyPaymentDegradation } from "@/lib/pipelines/payment-degradation/trigger";
...
const PIPELINE = "payment-degradation" as const;
...
export const runPaymentDegradation = async (
  paymentEvent: PaymentEvent,
): Promise<PipelineRunResult> => {
  const qualification = qualifyPaymentDegradation(paymentEvent);
  ...
  try {
    ...
    const agentOutput = await diagnosePaymentDegradation(context);
