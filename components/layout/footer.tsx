...
const pipelineLinks = [
  {
    ...
    href: "/simulator?pipeline=payment-degradation",
  },
  { label: "Checkout Drop-off", href: "/simulator?pipeline=checkout-dropoff" },
  {
    label: "Failed Subscription",
    href: "/simulator?pipeline=failed-subscription",
  },
];
